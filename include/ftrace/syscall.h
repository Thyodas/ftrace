...
static syscall_t syscall_table[330] = {
    ...
    {59, "execve", 3, NUM, STRING, STRING_TABLE, ENV_TABLE, 0, 0, 0},
    ...
    {239, "get_mempolicy", 5, NUM, NUM_P, UNSIGNED_P, UNSIGNED, VOID_P,
        UNSIGNED, 0},
    {240, "mq_open", 2, MQD_T, STRING, NUM, 0, 0, 0, 0},
    ...
    {262, "newfstatat", 4, NUM, NUM, STRING, STRUCT_STAT_P, UNSIGNED, 0, 0},
    ...
    {322, "execveat", 5, NUM, NUM, STRING, STRING_TABLE, ENV_TABLE, NUM, 0},
...
#define SYSCALL_NB (sizeof(syscall_table) / sizeof(syscall_t) - 1)
